...
import ExampleDoc from '../../Assest/resume/Sandip_Sharma_Resume.pdf'
    ...
    return (
        <PersonalContainer className="container">
            <div className="row no-gutters">
                <div data-aos="fade-right" data-aos-delay="1000" className="col-lg-6 col-sm-12 col-md-12">
                ...
                <div className="col-lg-6 col-sm-12 col-md-12">
                    <div className="row">
                        {careerDetails.map((val,index) => (
                            <div data-aos="flip-left" data-aos-delay={(index+1) * 500}  className="col-lg-6 col-md-6">
                                <DetailBox>
                                    <h3>{val.value}</h3>
                                    <p>{val.label}</p>
                                </DetailBox>
